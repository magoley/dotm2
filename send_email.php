<?php
//send_email.php
$email_from = "absender@agile-podcast.de";   //Absender falls keiner angegeben wurde
$sendermail_antwort = true;      //E-Mail Adresse des Besuchers als Absender. false= Nein ; true = Ja
$name_von_emailfeld = "Email";   //Feld in der die Absenderadresse steht
 
$empfaenger = "chris@dailyofthemonth.de"; //Empfänger-Adresse
$mail_cc = ""; //CC-Adresse, diese E-Mail-Adresse bekommt einer weitere Kopie
$betreff = "Neue Kontaktanfrage von agile-podcast.de"; //Betreff der Email
 
$url_ok = "https://www.agile-podcast.de/contact/thankyou"; //Zielseite, wenn E-Mail erfolgreich versendet wurde
$url_fehler = "https://www.agile-podcast.de/contact/error"; //Zielseite, wenn E-Mail nicht gesendet werden konnte
